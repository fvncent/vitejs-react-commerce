...
const navigation = [
  ...
  { name: 'Products', to: '/products', icon: ClockIcon, current: false },
  { name: 'Orders', to: '/orders', icon: ScaleIcon, current: false },
  { name: 'Discount', to: '/discount', icon: CreditCardIcon, current: false },
  { name: 'Customers', to: '/customers', icon: UserGroupIcon, current: false },
  {
    name: 'Reports',
    to: '/reports',
